...
import { MuscleMap, type MuscleZone } from './components/MuscleMap'
...
const sessionData:Record<MuscleGroup,ExerciseItem[]>={
 Pectoraux:[
  ...
  {name:'Écartés couchés',equipment:'Haltères',sets:'3 séries',img:'https://img.youtube.com/vi/_LwuS1PdbdM/hqdefault.jpg',video:'https://www.youtube.com/watch?v=_LwuS1PdbdM',target:'Pectoraux',secondary:'Deltoïdes ant.',reps:'10–15',rir:'1–2',rest:'1:30–2:00',anatomy:'/body-os/anatomy-cable-fly.svg',zoneView:'front',zonePrimary:['chestLower'],zoneSecondary:['frontDelt']},
  {name:'Dips',equipment:'Poids du corps',sets:'3 séries',img:'https://img.youtube.com/vi/yN6Q1UI_xkE/hqdefault.jpg',video:'https://www.youtube.com/watch?v=yN6Q1UI_xkE',target:'Pectoraux · Triceps',secondary:'Deltoïdes ant.',reps:'6–12',rir:'1–2',rest:'2:00–3:00',anatomy:'/body-os/anatomy-triceps.svg',zoneView:'front',zonePrimary:['chestLower','triceps'],zoneSecondary:['frontDelt']},
  {name:'Écarté poulie bas→haut',equipment:'Poulie',sets:'3 séries',img:'https://img.youtube.com/vi/eQ_NBB6OBH4/hqdefault.jpg',video:'https://www.youtube.com/watch?v=eQ_NBB6OBH4',target:'Haut des pectoraux',secondary:'Deltoïdes ant.',reps:'12–15',rir:'1–2',rest:'1:30',anatomy:'/body-os/anatomy-low-high-fly.svg',zoneView:'front',zonePrimary:['chestUpper'],zoneSecondary:['frontDelt']},
 ],
 Dos:[
  {name:'Tirage vertical',equipment:'Poulie',sets:'3 séries',img:'https://img.youtube.com/vi/VXKfH6ciEBI/hqdefault.jpg',video:'https://www.youtube.com/watch?v=VXKfH6ciEBI',target:'Grand dorsal',secondary:'Biceps',reps:'6–10',rir:'1–2',rest:'2:00–3:00',anatomy:'/body-os/anatomy-lat-pulldown.svg',zoneView:'back',zonePrimary:['lats'],zoneSecondary:['biceps']},
  {name:'Rowing machine',equipment:'Machine',sets:'3 séries',img:'https://img.youtube.com/vi/TeFo51Q_Nsc/hqdefault.jpg',video:'https://www.youtube.com/watch?v=TeFo51Q_Nsc',target:'Dos moyen',secondary:'Biceps · Deltoïdes post.',reps:'8–12',rir:'1–2',rest:'2:00–3:00',anatomy:'/body-os/anatomy-machine-row.svg',zoneView:'back',zonePrimary:['lats'],zoneSecondary:['biceps','rearDelt']},
  {name:'Rowing poitrine',equipment:'Machine',sets:'2 séries',img:'https://img.youtube.com/vi/0UBRfiO4zDs/hqdefault.jpg',video:'https://www.youtube.com/watch?v=0UBRfiO4zDs',target:'Rhomboïdes · Trapèzes',secondary:'Biceps',reps:'8–12',rir:'1–2',rest:'2:00',anatomy:'/body-os/anatomy-chest-row.svg',zoneView:'back',zonePrimary:['traps'],zoneSecondary:['biceps']},
  {name:'Pulldown unilatéral',equipment:'Poulie',sets:'2 séries',img:'https://img.youtube.com/vi/iVfZB4YmLRM/hqdefault.jpg',video:'https://www.youtube.com/watch?v=iVfZB4YmLRM',target:'Grand dorsal',secondary:'Biceps',reps:'10–15',rir:'1–2',rest:'1:30',anatomy:'/body-os/anatomy-one-arm-cable.svg',zoneView:'back',zonePrimary:['lats'],zoneSecondary:['biceps']},
  {name:'Reverse fly',equipment:'Poulie',sets:'3 séries',img:'https://img.youtube.com/vi/buuYPLVXsJg/hqdefault.jpg',video:'https://www.youtube.com/watch?v=buuYPLVXsJg',target:'Deltoïdes post.',secondary:'Haut du dos',reps:'12–20',rir:'1–2',rest:'1:30',anatomy:'/body-os/anatomy-reverse-fly.svg',zoneView:'back',zonePrimary:['rearDelt'],zoneSecondary:['traps']},
 ],
 Épaules:[
  {name:'Développé épaules',equipment:'Machine',sets:'3 séries',img:'https://img.youtube.com/vi/WvLMauqrnK8/hqdefault.jpg',video:'https://www.youtube.com/watch?v=WvLMauqrnK8',target:'Deltoïdes ant. · moyen',secondary:'Triceps',reps:'6–10',rir:'1–2',rest:'2:00–3:00',anatomy:'/body-os/anatomy-shoulder-press.svg',zoneView:'front',zonePrimary:['frontDelt','sideDelt'],zoneSecondary:['triceps']},
  {name:'Élévations latérales',equipment:'Haltères',sets:'4 séries',img:'/body-os/demo-lat-raise-approved.jpg',video:'https://www.youtube.com/results?search_query=lateral+raise+technique+renaissance+periodization',target:'Deltoïde moyen',secondary:'—',reps:'10–20',rir:'1–2',rest:'1:15–1:45',anatomy:'/body-os/anatomy-lat-raise.svg',zoneView:'front',zonePrimary:['sideDelt']},
  {name:'Élévations poulie',equipment:'Poulie',sets:'3 séries',img:'https://img.youtube.com/vi/zpbm-xRHB6k/hqdefault.jpg',video:'https://www.youtube.com/watch?v=zpbm-xRHB6k',target:'Deltoïde moyen',secondary:'—',reps:'12–20',rir:'1–2',rest:'1:15',anatomy:'/body-os/anatomy-lat-raise-2.svg',zoneView:'front',zonePrimary:['sideDelt']},
  {name:'Reverse pec deck',equipment:'Machine',sets:'3 séries',img:'https://img.youtube.com/vi/Z84HkxGCBqQ/hqdefault.jpg',video:'https://www.youtube.com/watch?v=Z84HkxGCBqQ',target:'Deltoïdes post.',secondary:'Haut du dos',reps:'12–20',rir:'1–2',rest:'1:30',anatomy:'/body-os/anatomy-reverse-pec.svg',zoneView:'back',zonePrimary:['rearDelt'],zoneSecondary:['traps']},
  {name:'Élévation frontale',equipment:'Poulie',sets:'2 séries',img:'https://img.youtube.com/vi/KjqHI59JizY/hqdefault.jpg',video:'https://www.youtube.com/watch?v=KjqHI59JizY',target:'Deltoïde ant.',secondary:'—',reps:'10–15',rir:'2',rest:'1:30',anatomy:'/body-os/anatomy-single-press.svg',zoneView:'front',zonePrimary:['frontDelt']},
 ],
 Jambes:[
  {name:'Hack squat',equipment:'Machine',sets:'3 séries',img:'https://img.youtube.com/vi/scs5XcsZuc8/hqdefault.jpg',video:'https://www.youtube.com/watch?v=scs5XcsZuc8',target:'Quadriceps',secondary:'Fessiers',reps:'6–10',rir:'1–2',rest:'2:30–3:30',anatomy:'/body-os/anatomy-hack-squat.svg',zoneView:'front',zonePrimary:['quads']},
  {name:'Fentes bulgares',equipment:'Haltères',sets:'3 séries',img:'https://img.youtube.com/vi/SkNsa3eBwLA/hqdefault.jpg',video:'https://www.youtube.com/watch?v=SkNsa3eBwLA',target:'Quadriceps · Fessiers',secondary:'Ischios',reps:'8–12 / jambe',rir:'1–2',rest:'2:00–2:30',anatomy:'/body-os/anatomy-bulgarian.svg',zoneView:'front',zonePrimary:['quads'],zoneSecondary:['glutes']},
  {name:'Leg curl',equipment:'Machine',sets:'3 séries',img:'https://img.youtube.com/vi/IOufFLwNOTU/hqdefault.jpg',video:'https://www.youtube.com/watch?v=IOufFLwNOTU',target:'Ischio-jambiers',secondary:'—',reps:'8–15',rir:'1–2',rest:'1:30–2:00',anatomy:'/body-os/anatomy-leg-curl.svg',zoneView:'back',zonePrimary:['hamstrings']},
  {name:'Leg extension',equipment:'Machine',sets:'3 séries',img:'https://img.youtube.com/vi/m0FOpMEgero/hqdefault.jpg',video:'https://www.youtube.com/watch?v=m0FOpMEgero',target:'Quadriceps',secondary:'—',reps:'10–15',rir:'1–2',rest:'1:30–2:00',anatomy:'/body-os/anatomy-leg-extension.svg',zoneView:'front',zonePrimary:['quads']},
  {name:'Mollets',equipment:'Machine',sets:'4 séries',img:'https://img.youtube.com/vi/GAQ-oohMhog/hqdefault.jpg',video:'https://www.youtube.com/watch?v=GAQ-oohMhog',target:'Mollets',secondary:'—',reps:'8–15',rir:'1–2',rest:'1:30',anatomy:'/body-os/anatomy-calf.svg',zoneView:'front',zonePrimary:['calves']},
 ],
 Bras:[
  {name:'Curl incliné',equipment:'Haltères',sets:'3 séries',img:'https://img.youtube.com/vi/HhHHBj3qTJ4/hqdefault.jpg',video:'https://www.youtube.com/watch?v=HhHHBj3qTJ4',target:'Biceps',secondary:'Brachial',reps:'8–12',rir:'1–2',rest:'1:30–2:00',anatomy:'/body-os/anatomy-incline-curl.svg',zoneView:'front',zonePrimary:['biceps']},
  {name:'Curl poulie',equipment:'Poulie',sets:'3 séries',img:'https://img.youtube.com/vi/aLRv0hRiXhc/hqdefault.jpg',video:'https://www.youtube.com/watch?v=aLRv0hRiXhc',target:'Biceps',secondary:'Brachial',reps:'10–15',rir:'1–2',rest:'1:30',anatomy:'/body-os/anatomy-cable-curl.svg',zoneView:'front',zonePrimary:['biceps']},
...
function Exercise({item,index,total,group,setView,onDone}:{item:ExerciseItem,index:number,total:number,group:MuscleGroup,setView:(v:WorkoutView)=>void,onDone:()=>void}){
 ...
 return <main className="v9Page v9Exercise"><header className="v9TitleBar"><button onClick={()=>setView('session')}>‹</button><div><b>{group.toUpperCase()}</b><small>SÉANCE EN COURS</small></div><button className="v93Dots" onClick={()=>setToast('Options exercice')}>•••</button></header>
  <div className="v9ExerciseHead"><span><small>EXERCICE {index+1}/{total}</small><b>{item.name}</b><em>{item.equipment.toUpperCase()} · {group.toUpperCase()}</em></span><MuscleMap view={item.zoneView} primary={item.zonePrimary} secondary={item.zoneSecondary}/></div>
