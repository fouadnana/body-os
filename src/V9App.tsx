...
const sessionData:Record<MuscleGroup,ExerciseItem[]>={
 Pectoraux:[
  ...
  {name:'Écarté poulie bas→haut',equipment:'Poulie',sets:'3 séries',img:'https://img.youtube.com/vi/eQ_NBB6OBH4/hqdefault.jpg',video:'https://www.youtube.com/watch?v=eQ_NBB6OBH4',target:'Haut des pectoraux',secondary:'Deltoïdes ant.',reps:'12–15',rir:'1–2',rest:'1:30',anatomy:'/body-os/anatomy-low-high-fly.svg'},
 ],
 Dos:[
 ...
 Jambes:[
  ...
  {name:'Fentes bulgares',equipment:'Haltères',sets:'3 séries',img:'https://img.youtube.com/vi/SkNsa3eBwLA/hqdefault.jpg',video:'https://www.youtube.com/watch?v=SkNsa3eBwLA',target:'Quadriceps · Fessiers',secondary:'Ischios',reps:'8–12 / jambe',rir:'1–2',rest:'2:00–2:30',anatomy:'/body-os/anatomy-bulgarian.svg'},
