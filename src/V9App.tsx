...
const sessionData:Record<MuscleGroup,ExerciseItem[]>={
 Pectoraux:[
  ...
  {name:'Écarté poulie bas→haut',equipment:'Poulie',sets:'3 séries',img:'/body-os/demo-low-high-fly.svg',video:'https://www.youtube.com/results?search_query=low+to+high+cable+fly+upper+chest+tutorial',target:'Haut des pectoraux',secondary:'Deltoïdes ant.',reps:'12–15',rir:'1–2',rest:'1:30',anatomy:'/body-os/anatomy-low-high-fly.svg'},
 ],
 Dos:[
 ...
 Jambes:[
  ...
  {name:'Fentes bulgares',equipment:'Haltères',sets:'3 séries',img:'/body-os/demo-bulgarian.svg',video:'https://www.youtube.com/results?search_query=bulgarian+split+squat+tutorial',target:'Quadriceps · Fessiers',secondary:'Ischios',reps:'8–12 / jambe',rir:'1–2',rest:'2:00–2:30',anatomy:'/body-os/anatomy-bulgarian.svg'},
