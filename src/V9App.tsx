...
const sessionData:Record<MuscleGroup,ExerciseItem[]>={
 ...
 Dos:[
  ...
  {name:'Reverse fly',equipment:'Poulie',sets:'3 séries',img:'https://shopbuilder.eu/images/bbcomment/files/175397378_l.jpg',video:'https://www.youtube.com/results?search_query=reverse+fly+rear+delt+exercise+tutorial',target:'Deltoïdes post.',secondary:'Haut du dos',reps:'12–20',rir:'1–2',rest:'1:30',anatomy:'/body-os/anatomy-reverse-fly.svg',zoneView:'back',zonePrimary:['rearDelt'],zoneSecondary:['traps']},
 ],
 Épaules:[
  ...
  {name:'Élévation frontale',equipment:'Poulie',sets:'2 séries',img:'https://bodymaster.ru/media/medialibrary/iblock/eff/eff88f5dcad41aa853ca89670d063362.jpg',video:'https://www.youtube.com/results?search_query=cable+front+raise+exercise+tutorial',target:'Deltoïde ant.',secondary:'—',reps:'10–15',rir:'2',rest:'1:30',anatomy:'/body-os/anatomy-single-press.svg',zoneView:'front',zonePrimary:['frontDelt']},
 ],
 Jambes:[
  {name:'Hack squat',equipment:'Machine',sets:'3 séries',img:'https://http2.mlstatic.com/D_NQ_NP_680346-MEC110766514119_042026-O.webp',video:'https://www.youtube.com/watch?v=scs5XcsZuc8',target:'Quadriceps',secondary:'Fessiers',reps:'6–10',rir:'1–2',rest:'2:30–3:30',anatomy:'/body-os/anatomy-hack-squat.svg',zoneView:'front',zonePrimary:['quads']},
  ...
  {name:'Leg curl',equipment:'Machine',sets:'3 séries',img:'https://cdn.corenutrition.fi/images/artiklar/sittande%20l%C3%A5rcurl-4-892.jpg',video:'https://www.youtube.com/results?search_query=seated+leg+curl+exercise+tutorial',target:'Ischio-jambiers',secondary:'—',reps:'8–15',rir:'1–2',rest:'1:30–2:00',anatomy:'/body-os/anatomy-leg-curl.svg',zoneView:'back',zonePrimary:['hamstrings']},
  {name:'Leg extension',equipment:'Machine',sets:'3 séries',img:'https://images.surferseo.art/8bbc18c1-a93f-4d65-ac69-dcc6beef7d08.png',video:'https://www.youtube.com/watch?v=m0FOpMEgero',target:'Quadriceps',secondary:'—',reps:'10–15',rir:'1–2',rest:'1:30–2:00',anatomy:'/body-os/anatomy-leg-extension.svg',zoneView:'front',zonePrimary:['quads']},
  {name:'Mollets',equipment:'Machine',sets:'4 séries',img:'https://primary.jwwb.nl/public/t/y/m/temp-opfgypihlwatynrocmva/diferencia-entre-gemelos-y-soleo-standard.png',video:'https://www.youtube.com/results?search_query=standing+calf+raise+exercise+tutorial',target:'Mollets',secondary:'—',reps:'8–15',rir:'1–2',rest:'1:30',anatomy:'/body-os/anatomy-calf.svg',zoneView:'front',zonePrimary:['calves']},
 ],
 Bras:[
  {name:'Curl incliné',equipment:'Haltères',sets:'3 séries',img:'https://hips.hearstapps.com/hmg-prod/images/bb6-67cb1bfd4a840.png',video:'https://www.youtube.com/watch?v=HhHHBj3qTJ4',target:'Biceps',secondary:'Brachial',reps:'8–12',rir:'1–2',rest:'1:30–2:00',anatomy:'/body-os/anatomy-incline-curl.svg',zoneView:'front',zonePrimary:['biceps']},
  {name:'Curl poulie',equipment:'Poulie',sets:'3 séries',img:'https://i0.wp.com/www.muscleandfitness.com/wp-content/uploads/2019/12/standing-cable-curl2.jpg?quality=80&strip=all',video:'https://www.youtube.com/results?search_query=standing+cable+curl+exercise+tutorial',target:'Biceps',secondary:'Brachial',reps:'10–15',rir:'1–2',rest:'1:30',anatomy:'/body-os/anatomy-cable-curl.svg',zoneView:'front',zonePrimary:['biceps']},
  {name:'Curl assis',equipment:'Haltères',sets:'2 séries',img:'https://irp.cdn-website.com/5dcbaf2a/dms3rep/multi/Strength_HR-75423fa0-4f520c7a.jpg',video:'https://www.youtube.com/results?search_query=seated+dumbbell+curl+exercise+tutorial',target:'Biceps',secondary:'Avant-bras',reps:'10–15',rir:'1–2',rest:'1:30',anatomy:'/body-os/anatomy-seated-curl.svg',zoneView:'front',zonePrimary:['biceps'],zoneSecondary:['forearm']},
